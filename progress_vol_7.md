# Progress Log - Tiến độ dịch thuật Volume 7
...
Dưới đây là danh sách các Phase tương ứng với từng phần dịch (chunk). Mỗi phần sẽ được dịch, áp dụng glossary/character/relationship và ghi nhận kết quả vào thư mục `translated/vol_7/`.
...
| **4** | Chapter 1: At the Yakagi Residence - Part 3 | `chapter_1_at_the_yakagi_residence_part_3.txt` | 200 | 200 | 2021 | `chapter_1_at_the_yakagi_residence_part_3.md` | **Hoàn thành** |
| **5** | Chapter 1: At the Yakagi Residence - Part 4 | `chapter_1_at_the_yakagi_residence_part_4.txt` | 200 | 200 | 2017 | `chapter_1_at_the_yakagi_residence_part_4.md` | **Hoàn thành** |
...
| **10** | Chapter 2: Bad News Always Comes - Part 1 | `chapter_2_bad_news_always_comes_part_1.txt` | 200 | 200 | 2092 | `chapter_2_bad_news_always_comes_part_1.md` | **Hoàn thành** |
| **11** | Chapter 2: Bad News Always Comes - Part 2 | `chapter_2_bad_news_always_comes_part_2.txt` | 200 | 200 | 1956 | `chapter_2_bad_news_always_comes_part_2.md` | **Hoàn thành** |
| **12** | Chapter 2: Bad News Always Comes - Part 3 | `chapter_2_bad_news_always_comes_part_3.txt` | 200 | 200 | 2079 | `chapter_2_bad_news_always_comes_part_3.md` | **Hoàn thành** |
| **13** | Chapter 2: Bad News Always Comes - Part 4 | `chapter_2_bad_news_always_comes_part_4.txt` | 200 | 200 | 2059 | `chapter_2_bad_news_always_comes_part_4.md` | **Chưa bắt đầu** |
| **14** | Chapter 2: Bad News Always Comes - Part 5 | `chapter_2_bad_news_always_comes_part_5.txt` | 200 | 200 | 2160 | `chapter_2_bad_news_always_comes_part_5.md` | **Chưa bắt đầu** |
| **15** | Chapter 2: Bad News Always Comes - Part 6 | `chapter_2_bad_news_always_comes_part_6.txt` | 200 | 200 | 2036 | `chapter_2_bad_news_always_comes_part_6.md` | **Chưa bắt đầu** |
| **16** | Chapter 2: Bad News Always Comes - Part 7 | `chapter_2_bad_news_always_comes_part_7.txt` | 200 | 200 | 2029 | `chapter_2_bad_news_always_comes_part_7.md` | **Chưa bắt đầu** |
...
| **21** | Chapter 2: Bad News Always Comes - Part 12 | `chapter_2_bad_news_always_comes_part_12.txt` | 200 | 200 | 2006 | `chapter_2_bad_news_always_comes_part_12.md` | **Chưa bắt đầu** |
| **22** | Chapter 2: Bad News Always Comes - Part 13 | `chapter_2_bad_news_always_comes_part_13.txt` | 200 | 200 | 2114 | `chapter_2_bad_news_always_comes_part_13.md` | **Chưa bắt đầu** |
| **23** | Chapter 2: Bad News Always Comes - Part 14 | `chapter_2_bad_news_always_comes_part_14.txt` | 200 | 200 | 1968 | `chapter_2_bad_news_always_comes_part_14.md` | **Chưa bắt đầu** |
| **24** | Chapter 2: Bad News Always Comes - Part 15 | `chapter_2_bad_news_always_comes_part_15.txt` | 10 | 10 | 92 | `chapter_2_bad_news_always_comes_part_15.md` | **Chưa bắt đầu** |
| **25** | Chapter 3: Their Respective Battles - Part 1 | `chapter_3_their_respective_battles_part_1.txt` | 200 | 200 | 2252 | `chapter_3_their_respective_battles_part_1.md` | **Chưa bắt đầu** |
| **26** | Chapter 3: Their Respective Battles - Part 2 | `chapter_3_their_respective_battles_part_2.txt` | 200 | 200 | 2140 | `chapter_3_their_respective_battles_part_2.md` | **Chưa bắt đầu** |
| **27** | Chapter 3: Their Respective Battles - Part 3 | `chapter_3_their_respective_battles_part_3.txt` | 200 | 200 | 1951 | `chapter_3_their_respective_battles_part_3.md` | **Chưa bắt đầu** |
| **28** | Chapter 3: Their Respective Battles - Part 4 | `chapter_3_their_respective_battles_part_4.txt` | 200 | 200 | 2202 | `chapter_3_their_respective_battles_part_4.md` | **Chưa bắt đầu** |
| **29** | Chapter 3: Their Respective Battles - Part 5 | `chapter_3_their_respective_battles_part_5.txt` | 106 | 106 | 1127 | `chapter_3_their_respective_battles_part_5.md` | **Chưa bắt đầu** |
| **30** | Chapter 4: So That I Can Be Myself - Part 1 | `chapter_4_so_that_i_can_be_myself_part_1.txt` | 200 | 200 | 2113 | `chapter_4_so_that_i_can_be_myself_part_1.md` | **Chưa bắt đầu** |
| **31** | Chapter 4: So That I Can Be Myself - Part 2 | `chapter_4_so_that_i_can_be_myself_part_2.txt` | 200 | 200 | 1958 | `chapter_4_so_that_i_can_be_myself_part_2.md` | **Chưa bắt đầu** |
...
| **36** | Chapter 4: So That I Can Be Myself - Part 7 | `chapter_4_so_that_i_can_be_myself_part_7.txt` | 92 | 92 | 978 | `chapter_4_so_that_i_can_be_myself_part_7.md` | **Chưa bắt đầu** |
