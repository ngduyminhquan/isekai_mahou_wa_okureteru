...
pdf_path = os.path.join(base_dir, "source", "vol_7", "_OceanofPDF.com_The_Magic_in_this_Other_World_is_Too_Far_Behind_Volume_7_-_Gamei_Hitsuji.pdf")
out_dir = os.path.join(base_dir, "source", "vol_7")
img_dir = os.path.join(base_dir, "source", "images", "vol_7")
translated_dir = os.path.join(base_dir, "translated", "vol_7")
progress_path = os.path.join(base_dir, "progress_vol_7.md")
...
md = f"""# Progress Log - Tiến độ dịch thuật Volume 7
...
print("Done generating chapters and progress_vol_7.md")
