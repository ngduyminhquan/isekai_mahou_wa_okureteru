...
pdf_path = os.path.join(base_dir, "source", "vol_8", "_OceanofPDF.com_The_Magic_in_this_Other_World_is_Too_Far_Behind_Volume_8_-_Gamei_Hitsuji.pdf")
out_dir = os.path.join(base_dir, "source", "vol_8")
img_dir = os.path.join(base_dir, "source", "images", "vol_8")
translated_dir = os.path.join(base_dir, "translated", "vol_8")
progress_path = os.path.join(base_dir, "progress_vol_8.md")
...
md = f"""# Progress Log - Tiến độ dịch thuật Volume 8
...
print("Done generating chapters and progress_vol_8.md")
